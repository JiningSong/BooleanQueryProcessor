...
public class IndexReader {
	 ...
	 */
	public TreeSet<String> search(final String fieldName, String word) throws IOException, CorruptIndexException {
	 ...
	 */
	private TreeSet<String> query(final Term term) throws IOException, CorruptIndexException {
		TreeSet<String> hits = new TreeSet<String>();
		...
		for (Posting p : postingsList) {
			...
			//read stored content
			// Document doc = index.document(p.getIdentifier());

			//add hit to the list
			hits.add(p.getIdentifier());
		}
