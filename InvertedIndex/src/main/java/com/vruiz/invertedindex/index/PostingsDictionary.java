...
public class PostingsDictionary {
	 ...
	 */
	public boolean addTerm(final String tokenIdentifier, final Term term) {
		...
		Posting posting = new Posting(tokenIdentifier);
		// posting.addOccurrence();
		postingsList.add(posting);
